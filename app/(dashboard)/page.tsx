	...
	return (
		<div className="flex flex-col min-h-screen bg-slate-50 font-sans text-slate-900">
			...
			<header className="bg-zinc-800 text-white shadow-lg top-0 z-50 print:hidden">
				<div className="w-full md:w-4/5 mx-auto px-6 py-4 flex flex-col md:flex-row gap-4">
			...
			<main
				ref={componentRef}
				className="grow w-full md:w-4/5 mx-auto px-6 mt-6 pb-64 print:p-5 print:mt-0"
			>
				...
				<div className="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden mb-6 print:shadow-none print:border-none print:mb-2">
					<div className="p-6 grid grid-cols-1 md:grid-cols-12 gap-8 items-end print:p-0 print:gap-4 print:block">
								...
								<div>
									...
									<div className="relative">
										<input
											...
											className="text-xs w-full pl-4 pr-4 py-3 bg-slate-50 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none font-mono text-lg transition-all"
										/>
									</div>
								</div>
							</div>
						...
						<div className="md:col-span-4 bg-slate-50 p-4 pb-6 rounded-lg border border-slate-100 print:hidden">
							...
							<div className="relative">
								<input
									...
									className={`w-full pl-4 pr-8 py-2 border rounded-lg focus:ring-2 outline-none font-mono text-xs transition-all ${
										showDiscount
											? "bg-white border-purple-300 text-purple-700 font-bold"
											: "bg-slate-100 text-slate-400 border-slate-200"
									}`}
								/>
								<span className="absolute right-3 top-2 text-slate-400 font-bold text-xs">
									%
								</span>
				...
				<div className="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden min-h-100 flex flex-col print:shadow-none print:border print:border-slate-300">
								...
								{lines.map((line) => (
									...
									>
										...
										<td className="py-3 px-4 align-top">
											...
											<input
												type="text"
												placeholder="inside/cover/bind/etc..."
												className="print:hidden w-full p-2.5 bg-white border border-slate-300 rounded-lg text-xs focus:ring-2 focus:ring-blue-500 outline-none shadow-sm"
												value={line.label}
												onChange={(e) =>
													updateLine(
														line.id,
					...
					<div className="p-4 bg-slate-50 border-t border-slate-200 flex gap-4 print:hidden">
						<button
							...
							className="flex text-sm items-center gap-2 px-5 py-2.5 bg-white border border-slate-300 text-slate-700 font-semibold rounded-lg shadow-sm hover:bg-blue-50"
						>
						...
						<button
							...
							className="flex text-sm items-center gap-2 px-5 py-2.5 bg-white border border-slate-300 text-purple-700 font-semibold rounded-lg shadow-sm hover:bg-purple-50"
						>
							<span className="leading-none">+</span> Add
							Finishing
						</button>
			...
			<footer className="bg-zinc-800 text-white shadow-lg p-5 mt-auto print:hidden">
				<h6 className="text-[8px] text-center uppercase tracking-widest">
					Developed by <a href="mailto:ralph@spectrumdubai.com"> <b>ralph@spectrumdubai.com</b></a><br />
					for <a href="https://spectrumdubai.com"> <b>Spectrum Print Solutions</b></a><br />
					© {currentYear}
				</h6>
			</footer>
		</div>
