...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 font-sans text-slate-900">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <div className="text-right hidden sm:block">
              <div className="text-xs text-slate-400 uppercase font-bold tracking-wider mb-1">Estimated Total</div>
      ...
      {/* MAIN CONTENT */}
      <main className="grow max-w-6xl w-full mx-auto px-6 mt-6 pb-64">
        
        {/* GLOBAL CONTROLS */}
        <div className="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden mb-6">
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
            ...
            <div className="w-full">
              ...
              <div className="relative">
                <input
                  type="number"
                  min="0"
                  // If value is 0, show empty string so the field looks blank (easier to type)
                  value={jobQty === 0 ? '' : jobQty}
                  // Allow 0 (which happens when they clear the input)
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200 text-xs font-bold text-slate-500 uppercase tracking-wider">
                  ...
                  <th className="py-4 px-4 min-w-52.5">Material / Description</th>
                  ...
                  <th className="py-4 px-4 w-28 text-right">Unit Price</th>
                  <th className="py-4 px-4 w-32 text-right pr-6">Line Total</th>
